    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {Object.entries(grouped).map(([category, items]) => (
        <div key={category} className="border border-neutral-800 rounded-xl overflow-hidden bg-[#111]">
          <div className="px-3 py-1.5 bg-neutral-900 border-b border-neutral-800 flex justify-between items-center">
          ...
          <div className="p-3 flex flex-col gap-2">
            {items.map(fact => (
              <div key={fact.id} className="flex justify-between items-start gap-3 border-b border-neutral-800/50 pb-2 last:border-0 last:pb-0">
                <div className="flex-1">
                  <span className="text-sm text-neutral-200 leading-tight block mb-1">{fact.value}</span>
                ...
                <div className="flex flex-col items-end gap-1">
                  <div className="flex flex-col items-end gap-1">
                    <span className="text-[9px] font-mono text-neutral-500 uppercase">AI CONFIDENCE</span>
